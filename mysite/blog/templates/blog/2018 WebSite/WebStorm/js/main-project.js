...
function loadBody() {
    var body = document.getElementsByClassName("softwing-project")[0];
...
function activateWeb() {
    ...
    if(language === 'korean') {
        if (lastWidth > 960) {
            ...
            document.getElementById("softwing-stylesheet-project").setAttribute("href", "../css/project.css");
        }
        else {
            {
                document.getElementById("softwing-header-top-ul").innerHTML = "<li class=\"softwing-header-top-li\" id=\"softwing-header-top-li-logo\">\n" +
            ...
            document.getElementById("softwing-stylesheet-project").setAttribute("href", "../css/project-m.css");
        }
    }
    else if(language === 'english') {
        if (lastWidth > 960) {
